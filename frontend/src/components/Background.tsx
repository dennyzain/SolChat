  ...
  return (
    <div
      ...
      className={cn(
        ...
        'before:content-[""] before:absolute before:top-1/2 before:left-1/2 before:block before:size-[140%],black_50%)] before:[background:radial-gradient(ellipse_at_50%_55%,transparent_10%,white_50%)] before:[transform:translate3d(-50%,-50%,0)]',
    ...
    >
      {children}
      <canvas ref={canvasRef} className="absolute inset-0 block size-full opacity-10" />
      <motion.div
        className={cn(
          ...
          "[background:linear-gradient(20deg,#00f8f1,#ffbd1e40_16.5%,#fe848f_33%,#fe848f40_49.5%,#00f8f1_66%,#00f8f180_85.5%,#ffbd1e_100%)_0_100%_/_100%_200%]"
        )}
        animate={{ backgroundPosition: "0% 300%" }}
        transition={{ duration: 5, ease: "linear", repeat: Infinity }}
      />
      <div className="absolute top-0 left-0 z-[7] size-full mix-blend-overlay opacity-50" />
    </div>
  );
}
